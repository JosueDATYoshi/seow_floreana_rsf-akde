---
title: "Short-eared Owl RSF – Floreana Island, Galápagos"
author: "Josue Arteaga-Torres"
date: "`r Sys.Date()`"
...
This project performs a **Resource Selection Function (RSF) analysis** of the Galápagos Short-eared Owl (*Asio flammeus galapagoensis*) on Floreana Island, Galápagos, Ecuador. Movement data from 16 GPS-tracked individuals are combined with environmental raster layers to model habitat selection using continuous-time movement modelling (ctmm).

The analysis estimates which environmental features (vegetation, land use, topography, road proximity) owls preferentially use or avoid relative to available habitat, accounting for autocorrelation in movement trajectories.
...
**AI disclaimer:** Code annotations and debugging were assisted by the Posit Assistant tool (v0.3.2) in RStudio 2026.04.0+526 "Globemaster Allium" (2026-04-18) for Windows.

---

<<<<<<< HEAD
<a href="https://github.com/JosueDATYoshi/seow_floreana_rsf-akde/tree/main">Short-eared Owl RSF – Floreana Island, Galápagos</a> © 2026 by <a href="https://example.com">Josue D. Arteaga-Torres</a> is licensed under <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a><img src="https://mirrors.creativecommons.org/presskit/icons/cc.svg" alt="" style="max-width: 1em;max-height:1em;margin-left: .2em;"><img src="https://mirrors.creativecommons.org/presskit/icons/by.svg" alt="" style="max-width: 1em;max-height:1em;margin-left: .2em;">
=======
...
Pre-computed model objects (`.RData`) are loaded directly to avoid re-running computationally expensive fits:
...
Figures are saved to `outputs/figures/` in both PDF and TIFF (600 dpi, LZW) formats.
...
> `ctmm` is under active development. If the CRAN version is outdated, install from GitHub:
...
A fixed random seed (`set.seed(3847)`) ensures the Monte Carlo integrator in `rsf.fit()` produces identical results across runs. Model fitting is parallelised across up to 6 CPU cores via `future::plan("multisession")`.
